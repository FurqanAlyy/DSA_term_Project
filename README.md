...
A console-based movie streaming platform built in C++ using core DSA concepts that simulates core features of a real streaming service — user accounts, movie browsing, watch history, watchlists, and trending charts.
